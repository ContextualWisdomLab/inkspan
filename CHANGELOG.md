...
- Added stale-generation conflict recovery ordering and one single-flight recovery request so a newer local edit cannot hide or duplicate the durable conflict workflow while retained work remains blocked
