...
- The browser harness builds every package subpath before serving; measure the complete pinned build envelope and keep `webServer.timeout` above it, otherwise a server timeout is infrastructure evidence rather than a browser assertion.
