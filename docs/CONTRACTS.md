...
| release evidence | exact four-file draft inventory including the protected aggregate SBOM, package/artifact/digest verification and repository evidence | downstream deployment and operational rollout |
