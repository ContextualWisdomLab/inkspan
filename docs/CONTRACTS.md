...
| release evidence | exact five-file draft inventory, package/artifact/digest verification and repository evidence | downstream deployment and operational rollout |
