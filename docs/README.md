...
| [`assessments/2026-08-10-conversation-documentation-reassessment.md`](assessments/2026-08-10-conversation-documentation-reassessment.md) | Dated whole-conversation reassessment, protected/active/operational deltas, and scheduler-control remediation |
...
Dated reassessments capture a reviewed source generation and its active/operational deltas without placing mutable PR heads or workflow-run identities into timeless architecture. They do not override protected `main`, accepted ADRs, or current exact-head evidence.
