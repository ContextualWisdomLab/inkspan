...
| [`email-output.md`](email-output.md) | Active deterministic email fragment/full-document authority, language/direction metadata, accessibility and host-owned transport boundary |
