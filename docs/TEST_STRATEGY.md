...
- package/release stale draft assets, unexpected or non-regular local entries, exact five-file inventory violations, incomplete remote uploads, GitHub-vs-local digest mismatch, stale exact-head evidence, mutable provenance inputs, and isolated packed-consumer behavior.
