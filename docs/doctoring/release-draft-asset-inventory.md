...
2. Fetch the canonical release-by-tag representation from the GitHub Releases REST API.
3. Require the remote object to remain a draft.
...
7. Fail closed before publication if any name, state, count, or digest differs.
...
GitHub. (n.d.-c). *REST API endpoints for releases*. GitHub Docs. Retrieved August 7, 2026, from https://docs.github.com/en/rest/releases/releases?apiVersion=2026-03-10
