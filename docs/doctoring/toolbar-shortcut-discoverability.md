...
The current mainline replacement branch replays the final reviewed behavior onto the current protected-main generation without changing the original RED/GREEN evidence lineage above. Its exact-head CI, security, coverage, packaging, and review evidence is independent and must be regenerated before merge.
