...
| Editor chrome design tokens / Storybook inventory | ADR 0031, `docs/design-tokens.md`, doctoring, token catalog, and Storybook stories | `present_current` | `implemented_on_protected_main` | Hosts can name, override, and preview the shipped repeating toolbar/editor token catalog; CSS remains presentation authority and host overrides retain host-owned accessibility verification. |
