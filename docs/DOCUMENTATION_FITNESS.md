...
- protected-main W3C `TextPositionSelector` evidence as a separate, versioned Unicode-code-point projection bound to the exact document revision, with grapheme-boundary validation and no selected quote text in ordinary evidence;
