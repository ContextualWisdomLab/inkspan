...
| `@contextualwisdomlab/cwl-editor/text-position-selector` | React-free deterministic W3C `TextPositionSelector` projection core; interactive capture, revision binding, authorization, persistence, and re-anchoring remain outside this subpath |
