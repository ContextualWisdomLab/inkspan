...
| `@contextualwisdomlab/cwl-editor/spreadsheet` | `implemented_on_active_pr` — framework-neutral bounded XLS/XLSX envelope preflight and parser-neutral worksheet-to-editor JSON conversion; real workbook parsing and editor insertion remain incomplete and unshipped |
