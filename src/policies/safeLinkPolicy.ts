/**
 * Framework-neutral hyperlink validation shared by editor and conversion paths.
 *
 * The policy accepts HTTP(S), mailto, tel, document-relative, query-only, and
 * fragment references. It rejects protocol-relative URLs, executable/local or
 * unknown schemes, embedded HTTP credentials, literal whitespace/control
 * characters, backslashes, malformed absolute URLs, and empty targets.
 */
...
/** Boolean adapter for callers that need a type guard instead of exceptions. */
