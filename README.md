...
| Office renderer | [`office/`](https://github.com/ContextualWisdomLab/inkspan/tree/main/office) | Strict JSON → DOCX/XLSX/PPTX Python package and CLI |
...
[`docs/design-tokens.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/design-tokens.md) for the token catalog and
[`docs/storybook-inventory.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/storybook-inventory.md) for the Storybook
...
[`docs/server-rendering.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/server-rendering.md) for the full hydration,
...
[`docs/imperative-envelope-persistence.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/imperative-envelope-persistence.md).
...
policy. See [`docs/selection-lifecycle.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/selection-lifecycle.md).
...
[`docs/revision-guarded-restore.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/revision-guarded-restore.md).
...
[`docs/accessibility.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/accessibility.md) for the complete integration
...
See [`docs/link-security.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/link-security.md) for enforcement points,
...
result claims. See
[`docs/revision-evidence-subpath.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/revision-evidence-subpath.md).
...
[`docs/document-envelope.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/document-envelope.md).
...
[`docs/document-autosave.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/document-autosave.md) for recovery, shutdown,
...
See [`docs/collaboration.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/docs/collaboration.md) for the provider contract,
...
[`src/fonts/OFL.txt`](https://github.com/ContextualWisdomLab/inkspan/blob/main/src/fonts/OFL.txt) and
[`src/fonts/NOTICE`](https://github.com/ContextualWisdomLab/inkspan/blob/main/src/fonts/NOTICE).

---

## Inkspan Office

Inkspan Office is a separate Python distribution under [`office/`](https://github.com/ContextualWisdomLab/inkspan/tree/main/office).
...
publication is atomic and race-safe. See [`office/README.md`](https://github.com/ContextualWisdomLab/inkspan/blob/main/office/README.md)
...
See [`LICENSE`](https://github.com/ContextualWisdomLab/inkspan/blob/main/LICENSE), [`src/fonts/OFL.txt`](https://github.com/ContextualWisdomLab/inkspan/blob/main/src/fonts/OFL.txt), and
[`src/fonts/NOTICE`](https://github.com/ContextualWisdomLab/inkspan/blob/main/src/fonts/NOTICE).
